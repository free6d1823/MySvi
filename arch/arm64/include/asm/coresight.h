...
extern bool coresight_log_enabled;
#define coresight_log(...)			\
	do {					\
		if (coresight_log_enabled)	\
			printf(__VA_ARGS__);	\
	} while (0)
#else
#define coresight_log(...)
