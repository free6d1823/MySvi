...
#define MK_MEMX(lvl, pt, addr) \
	MK_BLK(lvl, pt, addr, addr, ATTR_MEMX)
...
#define MK_DEV_2M_8X(pt, addr) \
	...
	MK_DEV_2M(pt, addr + MB(4)), \
	MK_DEV_2M(pt, addr + MB(6)), \
	MK_DEV_2M(pt, addr + MB(8)), \
	MK_DEV_2M(pt, addr + MB(10)), \
	MK_DEV_2M(pt, addr + MB(12)), \
	MK_DEV_2M(pt, addr + MB(14))

#define MK_DEV_2M_64X(pt, addr) \
	MK_DEV_2M_8X(pt, addr), \
	MK_DEV_2M_8X(pt, addr + MB(0x10)), \
	MK_DEV_2M_8X(pt, addr + MB(0x20)), \
	MK_DEV_2M_8X(pt, addr + MB(0x30)), \
	MK_DEV_2M_8X(pt, addr + MB(0x40)), \
	MK_DEV_2M_8X(pt, addr + MB(0x50)), \
