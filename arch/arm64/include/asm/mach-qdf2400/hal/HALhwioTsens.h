...
/************************************************************************************/
#define TSENS_SROT_REG_BASE                                                     (TS1_TSENS_TOP_BASE      + 0x00000000)
...
#define TSENS_TM_REG_BASE                                                       (TS1_TSENS_TOP_BASE      + 0x00010000)
...
/*
 * Sn_ID_ASSIGNMENT macros - ipcat is not generting macros for Sn_ID_ASSIGNMENT
 *   -- So add this only if the ipcat fails to generate relevant Sn_ID macros
 *   -- Once ipcat starts generating proper Sn_ID macros we can remove the below
 */
#ifndef HWIO_TSENS_Sn_ID_ASSIGNMENT_RMSK

#define HWIO_TSENS_Sn_ID_ASSIGNMENT_ADDR(base,n) ((base) + 0x000000a0 + 0x4 * (n))
#define HWIO_TSENS_Sn_ID_ASSIGNMENT_RMSK         HWIO_TSENS_S0_ID_ASSIGNMENT_RMSK
...
#define HWIO_TSENS_Sn_ID_ASSIGNMENT_SENSOR_ID_BMSK   HWIO_TSENS_S0_ID_ASSIGNMENT_SENSOR_ID_BMSK
#define HWIO_TSENS_Sn_ID_ASSIGNMENT_SENSOR_ID_SHFT   HWIO_TSENS_S0_ID_ASSIGNMENT_SENSOR_ID_SHFT

#if (HWIO_TSENS_Sn_ID_ASSIGNMENT_ADDR(0,0) != HWIO_TSENS_S0_ID_ASSIGNMENT_ADDR(0)) || (HWIO_TSENS_Sn_ID_ASSIGNMENT_ADDR(0, 15) != HWIO_TSENS_S15_ID_ASSIGNMENT_ADDR(0))
#error "HALhwioTsens.h: Need to update the Sn_ID_ASSIGNMENT Macros"
#endif

#endif /* HWIO_TSENS_Sn_ID_ASSIGNMENT_ADDR end */
/***************************************************************************/
