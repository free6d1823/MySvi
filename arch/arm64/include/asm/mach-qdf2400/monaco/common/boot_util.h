...
*   None.
*/
void qmemcpy( void*, const void*, uint32_t );
...
* 
*/
static __inline uint32_t boot_get_bit_set_position
(
  uint32_t num
)
{
...
void fast_memzi(
  void* dst_ptr,        /* Destination address */ 
  uint32_t len            /* Length to be to set to zero */
);
...
* 
* @brief
*    This function Counts the number of bits set in an uint32_t.
*   
* @param[in] input_val:  uint32_t Input value whose set bits need to be 
*                        counted. 
* 
* @par Dependencies
*    None
* 
* @retval
*    count: uint32_t Number of bits set to 1.
* 
* @par Side Effects
*    None
* 
