...
uint32_t Qdf2400V20PLLCfg[]  = {
	[GCCMW_WEST_PLL0] = 1000,
	[GCCMW_WEST_PLL1] = 800,
	[GCCE_EAST_PLL0] = 2000,
	[GCCE_EAST_PLL1] = 2000,
};

const uint64_t Qdf2400V20CBCRs[] = {
...
const struct ClockCfg Qdf2400V20CdivCfg[] = {
...
const clk_ctl_cfg Qdf2400V20RcgCfg[] = {
	/* IMC_CC */
	/* imc_proc_clk_src            [ 500.000MHz] */
	{
		.src_sel = 1, /* sys_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 500000000,
		.cmd_rcgr = IMC_CC_IMC_PROC_CMD_RCGR,
	},
	/* imc_clk_src                 [ 333.333MHz] */
	{
		.src_sel = 1, /* sys_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 333333333,
	...
	/* hmss_bus_clk_src            [ 100.000MHz] */
	{
		...
		.input_hz = 1000000000,
		.output_hz = 100000000,
		.cmd_rcgr = GCCMW_HMSS_BUS_CMD_RCGR,
	},
	...
	/* fan_tach_clk_src            [  25.000MHz] */
	{
		.src_sel = 2, /* west_pll0_out_main_div10 */
		.input_hz = 1000000000/10,
		.output_hz = 25000000,
		.cmd_rcgr = GCCMW_FAN_TACH_CMD_RCGR,
	},
	/* gp0_clk_src                 [ 200.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 200000000,
	...
	/* hdma_vbu_clk_src            [1000.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 1000000000,
	...
	/* sys_fab_vbu_clk_src         [ 500.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 500000000,
	...
	/* qdss_traceclkin_clk_src     [ 333.333MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 333333333,
	...
	/* parb2_ser_clk_src           [  25.000MHz] */
	{
		...
		.input_hz = 100000000,
		.output_hz = 25000000,
		.cmd_rcgr = GCCMW_PARB2_SER_CMD_RCGR,
	},
	...
	/* pcie_ss_0_vbu_clk_src       [1000.000MHz] */
	{
		.src_sel = 1, /* east_pll0_out_even */
		.input_hz = 2000000000/2,
		.output_hz = 1000000000,
	...
	/* pcie_ss_1_vbu_clk_src       [1000.000MHz] */
	{
		.src_sel = 1, /* east_pll0_out_even */
		.input_hz = 2000000000/2,
		.output_hz = 1000000000,
	...
	/* blsp3_qup0_spi_apps_clk_src [  50.000MHz] */
	{
		.src_sel = 4, /* west_pll1_out_main */
		.input_hz = 800000000,
		.output_hz = 50000000,
		.cmd_rcgr = PCC_SPI_CMD_RCGR(PCC_BLSP3_QUP0),
		.flags = CLK_MND_MASK(PCC_SPI_MND_MASK),
	},
	/* blsp3_qup1_spi_apps_clk_src [  50.000MHz] */
	{
		.src_sel = 4, /* west_pll1_out_main */
		.input_hz = 800000000,
		.output_hz = 50000000,
		.cmd_rcgr = PCC_SPI_CMD_RCGR(PCC_BLSP3_QUP1),
		.flags = CLK_MND_MASK(PCC_SPI_MND_MASK),
	},
	...
	/* sdcc0_apps_clk_src          [ 100.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 100000000,
		.cmd_rcgr = PCC_SDCC_APPS_CMD_RCGR(PCC_SDCC0),
		.flags = CLK_MND_MASK(PCC_SDCC_APPS_MND_MASK),
	},
	/* sdcc1_apps_clk_src          [ 100.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 100000000,
		.cmd_rcgr = PCC_SDCC_APPS_CMD_RCGR(PCC_SDCC1),
		.flags = CLK_MND_MASK(PCC_SDCC_APPS_MND_MASK),
	},
	/* sdcc2_apps_clk_src          [ 100.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 100000000,
		.cmd_rcgr = PCC_SDCC_APPS_CMD_RCGR(PCC_SDCC2),
		.flags = CLK_MND_MASK(PCC_SDCC_APPS_MND_MASK),
	},
	/* sdcc3_apps_clk_src          [ 100.000MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 100000000,
		.cmd_rcgr = PCC_SDCC_APPS_CMD_RCGR(PCC_SDCC3),
		.flags = CLK_MND_MASK(PCC_SDCC_APPS_MND_MASK),
	},
	/* usb2_mstr_clk_src           [  62.500MHz] */
	{
		.src_sel = 1, /* west_pll0_out_main */
		.input_hz = 1000000000,
		.output_hz = 62500000,
