...
pt_section pte pagetable[PT_MAX][MAX_PTE_ENTRIES] = {
	...
	/* for gic */
	MK_DEV_2M_SECURE(L2_0, GICD_gic3_BASE),

	MK_DEV_2M_SECURE(L2_0, SEC_SRAM_BASE),

	/* for uart */
	MK_DEV_2M(L2_0, UART_BASE(0)),

	MK_TBL(2, L2_1, L3_SVI, SVI_TEXT_BASE, 0),
	MK_PAGE_MEMX_128X(L3_SVI, SVI_TEXT_BASE),
	MK_PAGE_MEMX_128X(L3_SVI, SVI_TEXT_BASE + PAGE(0x80)),
	MK_PAGE_MEMX_128X(L3_SVI, SVI_TEXT_BASE + PAGE(0x100)),
