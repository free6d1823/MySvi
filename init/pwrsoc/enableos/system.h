#ifndef _ARM64_SYSTEM_H
#define _ARM64_SYSTEM_H
...
void disable_mmu_flush_dcache(void);

void armv8_switch_to_el2(uint64_t fdt_addr, uint64_t mach_nr, uint64_t args,
                         uint64_t arg4, uint64_t entry_point, uint64_t es_flag);

void armv8_switch_to_el1(uint64_t fdt_addr, uint64_t mach_nr, uint64_t args,
                         uint64_t arg4, uint64_t entry_point, uint64_t es_flag);
