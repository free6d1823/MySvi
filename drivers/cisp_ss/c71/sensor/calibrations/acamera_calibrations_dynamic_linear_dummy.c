...
static uint16_t _calibration_demosaic_config[] = {
    ...
    7987, // min_d_strength, Min threshold for the directional L_L in signed 2's complement s.12 format
    8008, // min_ud_strength, Min threshold for the un-directional L_Lu in signed 2's complement s.12 format
