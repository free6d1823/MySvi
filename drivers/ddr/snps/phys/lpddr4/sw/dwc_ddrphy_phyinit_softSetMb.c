...
int dwc_ddrphy_phyinit_softSetMb (phyinit_config_t* phyctx, int ps, char *field, int value) {
    ...
    PMU_SMB_LPDDR4_2D_t* mb_LPDDR4_2D = phyctx->mb_LPDDR4_2D;
    PMU_SMB_LPDDR4_2D_t* shdw_LPDDR4_2D = phyctx->shdw_LPDDR4_2D;
    ...
    if (Train2D == 0) {
      if ( strcmp(field, "Reserved00") == 0) {
        ...
        if(shdw_LPDDR4_1D[ps].Reserved18 == 0) {
          mb_LPDDR4_1D[ps].Reserved18 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 1, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].Reserved18);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].Reserved1F == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].Reserved1F);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].Reserved22 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].Reserved22);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR21_A0 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR21_A0);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR51_A0 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR51_A0);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR21_A1 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR21_A1);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR51_A1 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR51_A1);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR21_B0 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR21_B0);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR51_B0 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR51_B0);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR21_B1 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR21_B1);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MR51_B1 == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MR51_B1);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].LP4XMode == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].LP4XMode);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].Disable2D == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].Disable2D);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].VrefSamples == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].VrefSamples);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].ALT_RL == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].ALT_RL);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].MAIN_RL == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].MAIN_RL);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].RdWrPatternA == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].RdWrPatternA);
        }
      }
        ...
        if(shdw_LPDDR4_1D[ps].RdWrPatternB == 0) {
          ...
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].RdWrPatternB);
        }
      }
      else if ( strcmp(field, "RdWrInvertA") == 0) {
        if(shdw_LPDDR4_1D[ps].RdWrInvertA == 0) {
          mb_LPDDR4_1D[ps].RdWrInvertA = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 1, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].RdWrInvertA);
        }
      }
      else if ( strcmp(field, "RdWrInvertB") == 0) {
        if(shdw_LPDDR4_1D[ps].RdWrInvertB == 0) {
          mb_LPDDR4_1D[ps].RdWrInvertB = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 1, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 1, ps, field, mb_LPDDR4_1D[ps].RdWrInvertB);
        }
      }
      else {
      ...
      if ( strcmp(field, "Reserved00") == 0) {
        ...
        if (shdw_LPDDR4_2D[ps].Reserved18 == 0) {
          mb_LPDDR4_2D[ps].Reserved18 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].Reserved18);
        }
      }
      else if ( strcmp(field, "Reserved1A") == 0) {
        ...
        if (shdw_LPDDR4_2D[ps].Reserved1F == 0) {
          mb_LPDDR4_2D[ps].Reserved1F = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].Reserved1F);
        }
      }
        ...
        if (shdw_LPDDR4_2D[ps].Reserved22 == 0) {
          mb_LPDDR4_2D[ps].Reserved22 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].Reserved22);
        }
      }
      else if ( strcmp(field, "EnabledDQsChA") == 0) {
        ...
        if (shdw_LPDDR4_2D[ps].MR21_A0 == 0) {
          mb_LPDDR4_2D[ps].MR21_A0 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR21_A0);
        }
      }
      else if ( strcmp(field, "MR51_A0") == 0) {
        if (shdw_LPDDR4_2D[ps].MR51_A0 == 0) {
          mb_LPDDR4_2D[ps].MR51_A0 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR51_A0);
        }
      }
      else if ( strcmp(field, "MR21_A1") == 0) {
        if (shdw_LPDDR4_2D[ps].MR21_A1 == 0) {
          mb_LPDDR4_2D[ps].MR21_A1 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR21_A1);
        }
      }
      else if ( strcmp(field, "MR51_A1") == 0) {
        if (shdw_LPDDR4_2D[ps].MR51_A1 == 0) {
          mb_LPDDR4_2D[ps].MR51_A1 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR51_A1);
        }
      }
      else if ( strcmp(field, "MR21_B0") == 0) {
        if (shdw_LPDDR4_2D[ps].MR21_B0 == 0) {
          mb_LPDDR4_2D[ps].MR21_B0 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR21_B0);
        }
      }
      else if ( strcmp(field, "MR51_B0") == 0) {
        if (shdw_LPDDR4_2D[ps].MR51_B0 == 0) {
          mb_LPDDR4_2D[ps].MR51_B0 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR51_B0);
        }
      }
      else if ( strcmp(field, "MR21_B1") == 0) {
        if (shdw_LPDDR4_2D[ps].MR21_B1 == 0) {
          mb_LPDDR4_2D[ps].MR21_B1 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR21_B1);
        }
      }
      else if ( strcmp(field, "MR51_B1") == 0) {
        if (shdw_LPDDR4_2D[ps].MR51_B1 == 0) {
          mb_LPDDR4_2D[ps].MR51_B1 = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MR51_B1);
        }
      }
      else if ( strcmp(field, "LP4XMode") == 0) {
        if (shdw_LPDDR4_2D[ps].LP4XMode == 0) {
          mb_LPDDR4_2D[ps].LP4XMode = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].LP4XMode);
        }
      }
      else if ( strcmp(field, "Disable2D") == 0) {
        if (shdw_LPDDR4_2D[ps].Disable2D == 0) {
          mb_LPDDR4_2D[ps].Disable2D = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].Disable2D);
        }
      }
      else if ( strcmp(field, "VrefSamples") == 0) {
        if (shdw_LPDDR4_2D[ps].VrefSamples == 0) {
          mb_LPDDR4_2D[ps].VrefSamples = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].VrefSamples);
        }
      }
      else if ( strcmp(field, "ALT_RL") == 0) {
        if (shdw_LPDDR4_2D[ps].ALT_RL == 0) {
          mb_LPDDR4_2D[ps].ALT_RL = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].ALT_RL);
        }
      }
      else if ( strcmp(field, "MAIN_RL") == 0) {
        if (shdw_LPDDR4_2D[ps].MAIN_RL == 0) {
          mb_LPDDR4_2D[ps].MAIN_RL = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].MAIN_RL);
        }
      }
      else if ( strcmp(field, "RdWrPatternA") == 0) {
        if (shdw_LPDDR4_2D[ps].RdWrPatternA == 0) {
          mb_LPDDR4_2D[ps].RdWrPatternA = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].RdWrPatternA);
        }
      }
      else if ( strcmp(field, "RdWrPatternB") == 0) {
        if (shdw_LPDDR4_2D[ps].RdWrPatternB == 0) {
          mb_LPDDR4_2D[ps].RdWrPatternB = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].RdWrPatternB);
        }
      }
      else if ( strcmp(field, "RdWrInvertA") == 0) {
        if (shdw_LPDDR4_2D[ps].RdWrInvertA == 0) {
          mb_LPDDR4_2D[ps].RdWrInvertA = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].RdWrInvertA);
        }
      }
      else if ( strcmp(field, "RdWrInvertB") == 0) {
        if (shdw_LPDDR4_2D[ps].RdWrInvertB == 0) {
          mb_LPDDR4_2D[ps].RdWrInvertB = value;
          dwc_ddrphy_phyinit_cmnt ("%s Setting mb_LPDDR4_%dD[%d].%s to 0x%x\n", printf_header, 2, ps, field, value);
        }
        else {
          dwc_ddrphy_phyinit_cmnt ("%s mb_LPDDR4_%dD[%d].%s override to 0x%x\n", printf_header, 2, ps, field, mb_LPDDR4_2D[ps].RdWrInvertB);
        }
      }
    }
    else {
