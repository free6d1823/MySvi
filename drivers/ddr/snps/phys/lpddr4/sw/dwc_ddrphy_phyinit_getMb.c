    ...
    printf_header = " [dwc_ddrphy_phyinit_setMb]";
      ...
      if (Train2D == 0) {
          if ( strcmp(field, "Reserved00") == 0)
              ...
              return mb_LPDDR4_1D[ps].Reserved18;
              ...
              return mb_LPDDR4_1D[ps].RdWrInvertA;
          else if ( strcmp(field, "RdWrInvertB") == 0)
              return mb_LPDDR4_1D[ps].RdWrInvertB;
          else {
              ...
              if ( strcmp(field, "Reserved00") == 0)
                ...
                return  mb_LPDDR4_2D[ps].Reserved18;
              else if ( strcmp(field, "Reserved1A") == 0)
                ...
                return  mb_LPDDR4_2D[ps].Reserved1F;
                ...
                return  mb_LPDDR4_2D[ps].Reserved22;
              else if ( strcmp(field, "EnabledDQsChA") == 0)
                ...
                return  mb_LPDDR4_2D[ps].MR21_A0;
              else if ( strcmp(field, "MR51_A0") == 0)
                return  mb_LPDDR4_2D[ps].MR51_A0;
              else if ( strcmp(field, "MR21_A1") == 0)
                return  mb_LPDDR4_2D[ps].MR21_A1;
              else if ( strcmp(field, "MR51_A1") == 0)
                return  mb_LPDDR4_2D[ps].MR51_A1;
              else if ( strcmp(field, "MR21_B0") == 0)
                return  mb_LPDDR4_2D[ps].MR21_B0;
              else if ( strcmp(field, "MR51_B0") == 0)
                return  mb_LPDDR4_2D[ps].MR51_B0;
              else if ( strcmp(field, "MR21_B1") == 0)
                return  mb_LPDDR4_2D[ps].MR21_B1;
              else if ( strcmp(field, "MR51_B1") == 0)
                return  mb_LPDDR4_2D[ps].MR51_B1;
              else if ( strcmp(field, "LP4XMode") == 0)
                return  mb_LPDDR4_2D[ps].LP4XMode;
              else if ( strcmp(field, "Disable2D") == 0)
                return  mb_LPDDR4_2D[ps].Disable2D;
              else if ( strcmp(field, "VrefSamples") == 0)
                return  mb_LPDDR4_2D[ps].VrefSamples;
              else if ( strcmp(field, "ALT_RL") == 0)
                return  mb_LPDDR4_2D[ps].ALT_RL;
              else if ( strcmp(field, "MAIN_RL") == 0)
                return  mb_LPDDR4_2D[ps].MAIN_RL;
              else if ( strcmp(field, "RdWrPatternA") == 0)
                return  mb_LPDDR4_2D[ps].RdWrPatternA;
              else if ( strcmp(field, "RdWrPatternB") == 0)
                return  mb_LPDDR4_2D[ps].RdWrPatternB;
              else if ( strcmp(field, "RdWrInvertA") == 0)
                return  mb_LPDDR4_2D[ps].RdWrInvertA;
              else if ( strcmp(field, "RdWrInvertB") == 0)
                return  mb_LPDDR4_2D[ps].RdWrInvertB;
      }
      else {
