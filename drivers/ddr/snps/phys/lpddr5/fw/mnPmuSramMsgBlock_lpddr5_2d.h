typedef struct _PMU_SMB_LPDDR5_2D_t {
   ...
   uint16_t SequenceCtrl;     // Byte offset 0x10, CSR Addr 0x54008, Direction=In
                              ...
                              //    SequenceCtrl[3] = Run DRAM DCA - Dram duty cycle adjustment
                              //    SequenceCtrl[4] = Run PHY RdDCA - PHY read duty cycle adjustment
                              //    SequenceCtrl[5] = Run RdDQS - read dqs training
                              //    SequenceCtrl[6] = Run WrDq - write dq training
                              //    SequenceCtrl[7] = Run TxDFE - DRAM Tx DFE
   ...
   int8_t   CDD_ChA_WW_0_1;   // Byte offset 0x31, CSR Addr 0x54018, Direction=Out
                              ...
                              // See PUB Databook section 8.2 for details on use of CDD values.
   uint8_t  CATerminatingRankChA; // Byte offset 0x32, CSR Addr 0x54019, Direction=In
                              // Terminating Rank for CA bus on Channel A
                              //    0x0 = Rank 0 is terminating rank
                              //    0x1 = Rank 1 is terminating rank
   uint8_t  Reserved33; // Byte offset 0x33, CSR Addr 0x54019, Direction=N/A
                              
   uint8_t  Reserved34; // Byte offset 0x34, CSR Addr 0x5401a, Direction=N/A
                              
   uint8_t  TrainedVREFDQ_A0; // Byte offset 0x35, CSR Addr 0x5401a, Direction=Out
                              // Trained DQ Vref setting for Ch A Rank 0
   uint8_t  TrainedVREFDQ_A1; // Byte offset 0x36, CSR Addr 0x5401b, Direction=Out
                              // Trained DQ Vref setting for Ch A Rank 1
   uint8_t  RxClkDly_Margin_A0; // Byte offset 0x37, CSR Addr 0x5401b, Direction=Out
   ...
   uint8_t  VrefDac_Margin_A0; // Byte offset 0x38, CSR Addr 0x5401c, Direction=Out
   ...
   uint8_t  TxDqDly_Margin_A0; // Byte offset 0x39, CSR Addr 0x5401c, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  DeviceVref_Margin_A0; // Byte offset 0x3a, CSR Addr 0x5401d, Direction=Out
   ...
   uint8_t  RxClkDly_Margin_A1; // Byte offset 0x3b, CSR Addr 0x5401d, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  VrefDac_Margin_A1; // Byte offset 0x3c, CSR Addr 0x5401e, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TxDqDly_Margin_A1; // Byte offset 0x3d, CSR Addr 0x5401e, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  DeviceVref_Margin_A1; // Byte offset 0x3e, CSR Addr 0x5401f, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  EnabledDQsChB;    // Byte offset 0x3f, CSR Addr 0x5401f, Direction=In
                              // Total number of DQ bits enabled in PHY Channel B
   uint8_t  CsPresentChB;     // Byte offset 0x40, CSR Addr 0x54020, Direction=In
                              ...
                              // All other encodings are illegal
                              //  
   int8_t   CDD_ChB_RR_1_0;   // Byte offset 0x41, CSR Addr 0x54020, Direction=Out
                              // This is a signed integer value.
                              // Read to read critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_RR_0_1;   // Byte offset 0x42, CSR Addr 0x54021, Direction=Out
                              // This is a signed integer value.
                              // Read to read critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_RW_1_1;   // Byte offset 0x43, CSR Addr 0x54021, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 1 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_RW_1_0;   // Byte offset 0x44, CSR Addr 0x54022, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_RW_0_1;   // Byte offset 0x45, CSR Addr 0x54022, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_RW_0_0;   // Byte offset 0x46, CSR Addr 0x54023, Direction=Out
                              // This is a signed integer value.
                              // Read to write critical delay difference from cs01 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WR_1_1;   // Byte offset 0x47, CSR Addr 0x54023, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 1 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WR_1_0;   // Byte offset 0x48, CSR Addr 0x54024, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WR_0_1;   // Byte offset 0x49, CSR Addr 0x54024, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WR_0_0;   // Byte offset 0x4a, CSR Addr 0x54025, Direction=Out
                              // This is a signed integer value.
                              // Write  to read critical delay difference from cs 0 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WW_1_0;   // Byte offset 0x4b, CSR Addr 0x54025, Direction=Out
                              // This is a signed integer value.
                              // Write  to write critical delay difference from cs 1 to cs 0 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   int8_t   CDD_ChB_WW_0_1;   // Byte offset 0x4c, CSR Addr 0x54026, Direction=Out
                              // This is a signed integer value.
                              // Write  to write critical delay difference from cs 0 to cs 1 on Channel B
                              // See PUB Databook section 8.2 for details on use of CDD values.
   uint8_t  CATerminatingRankChB; // Byte offset 0x4d, CSR Addr 0x54026, Direction=In
   ...
   uint8_t  TrainedVREFDQ_B0; // Byte offset 0x50, CSR Addr 0x54028, Direction=Out
                              // Trained DQ Vref setting for Ch B Rank 0
   uint8_t  TrainedVREFDQ_B1; // Byte offset 0x51, CSR Addr 0x54028, Direction=Out
                              // Trained DQ Vref setting for Ch B Rank 1
   uint8_t  RxClkDly_Margin_B0; // Byte offset 0x52, CSR Addr 0x54029, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  VrefDac_Margin_B0; // Byte offset 0x53, CSR Addr 0x54029, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TxDqDly_Margin_B0; // Byte offset 0x54, CSR Addr 0x5402a, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  DeviceVref_Margin_B0; // Byte offset 0x55, CSR Addr 0x5402a, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  RxClkDly_Margin_B1; // Byte offset 0x56, CSR Addr 0x5402b, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  VrefDac_Margin_B1; // Byte offset 0x57, CSR Addr 0x5402b, Direction=Out
                              // Distance from the trained center to the closest failing region in phy DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TxDqDly_Margin_B1; // Byte offset 0x58, CSR Addr 0x5402c, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  DeviceVref_Margin_B1; // Byte offset 0x59, CSR Addr 0x5402c, Direction=Out
                              // Distance from the trained center to the closest failing region in device DAC steps. This value is the minimum of all eyes in this timing group.
   uint8_t  MR1_A0;           // Byte offset 0x5a, CSR Addr 0x5402d, Direction=in
                              // Value to be programmed in DRAM Mode Register 1 {Channel A, Rank 0}
   uint8_t  MR1_A1;           // Byte offset 0x5b, CSR Addr 0x5402d, Direction=in
                              // Value to be programmed in DRAM Mode Register 1 {Channel A, Rank 1}
   uint8_t  MR1_B0;           // Byte offset 0x5c, CSR Addr 0x5402e, Direction=in
                              // Value to be programmed in DRAM Mode Register 1 {Channel B, Rank 0}
   uint8_t  MR1_B1;           // Byte offset 0x5d, CSR Addr 0x5402e, Direction=in
                              // Value to be programmed in DRAM Mode Register 1 {Channel B, Rank 1}
   uint8_t  MR2_A0;           // Byte offset 0x5e, CSR Addr 0x5402f, Direction=in
                              // Value to be programmed in DRAM Mode Register 2 {Channel A, Rank 0}
   uint8_t  MR2_A1;           // Byte offset 0x5f, CSR Addr 0x5402f, Direction=in
                              // Value to be programmed in DRAM Mode Register 2 {Channel A, Rank 1}
   uint8_t  MR2_B0;           // Byte offset 0x60, CSR Addr 0x54030, Direction=in
                              // Value to be programmed in DRAM Mode Register 2 {Channel B, Rank 0}
   uint8_t  MR2_B1;           // Byte offset 0x61, CSR Addr 0x54030, Direction=in
                              // Value to be programmed in DRAM Mode Register 2 {Channel B, Rank 1}
   uint8_t  MR3_A0;           // Byte offset 0x62, CSR Addr 0x54031, Direction=in
                              // Value to be programmed in DRAM Mode Register 3 {Channel A, Rank 0}
   uint8_t  MR3_A1;           // Byte offset 0x63, CSR Addr 0x54031, Direction=in
                              // Value to be programmed in DRAM Mode Register 3 {Channel A, Rank 1}
   uint8_t  MR3_B0;           // Byte offset 0x64, CSR Addr 0x54032, Direction=in
                              // Value to be programmed in DRAM Mode Register 3 {Channel B, Rank 0}
   uint8_t  MR3_B1;           // Byte offset 0x65, CSR Addr 0x54032, Direction=in
                              // Value to be programmed in DRAM Mode Register 3 {Channel B, Rank 1}
   uint8_t  MR10_A0;          // Byte offset 0x66, CSR Addr 0x54033, Direction=in
                              // Value to be programmed in DRAM Mode Register 10 {Channel A, Rank 0}
   uint8_t  MR10_A1;          // Byte offset 0x67, CSR Addr 0x54033, Direction=in
                              // Value to be programmed in DRAM Mode Register 10 {Channel A, Rank 1}
   uint8_t  MR10_B0;          // Byte offset 0x68, CSR Addr 0x54034, Direction=in
                              // Value to be programmed in DRAM Mode Register 10 {Channel B, Rank 0}
   uint8_t  MR10_B1;          // Byte offset 0x69, CSR Addr 0x54034, Direction=in
                              // Value to be programmed in DRAM Mode Register 10 {Channel B, Rank 1}
   uint8_t  MR11_A0;          // Byte offset 0x6a, CSR Addr 0x54035, Direction=in
                              // Value to be programmed in DRAM Mode Register 11 {Channel A, Rank 0}
   uint8_t  MR11_A1;          // Byte offset 0x6b, CSR Addr 0x54035, Direction=in
                              // Value to be programmed in DRAM Mode Register 11 {Channel A, Rank 1}
   uint8_t  MR11_B0;          // Byte offset 0x6c, CSR Addr 0x54036, Direction=in
                              // Value to be programmed in DRAM Mode Register 11 {Channel B, Rank 0}
   uint8_t  MR11_B1;          // Byte offset 0x6d, CSR Addr 0x54036, Direction=in
                              // Value to be programmed in DRAM Mode Register 11 {Channel B, Rank 1}
   uint8_t  MR12_A0;          // Byte offset 0x6e, CSR Addr 0x54037, Direction=in
                              // Value to be programmed in DRAM Mode Register 12 {Channel A, Rank 0}
   uint8_t  MR12_A1;          // Byte offset 0x6f, CSR Addr 0x54037, Direction=in
                              // Value to be programmed in DRAM Mode Register 12 {Channel A, Rank 1}
   uint8_t  MR12_B0;          // Byte offset 0x70, CSR Addr 0x54038, Direction=in
                              // Value to be programmed in DRAM Mode Register 12 {Channel B, Rank 0}
   uint8_t  MR12_B1;          // Byte offset 0x71, CSR Addr 0x54038, Direction=in
                              // Value to be programmed in DRAM Mode Register 12 {Channel B, Rank 1}
   uint8_t  MR13_A0;          // Byte offset 0x72, CSR Addr 0x54039, Direction=in
                              // Value to be programmed in DRAM Mode Register 13 {Channel A, Rank 0}
   uint8_t  MR13_A1;          // Byte offset 0x73, CSR Addr 0x54039, Direction=in
                              // Value to be programmed in DRAM Mode Register 13 {Channel A, Rank 1}
   uint8_t  MR13_B0;          // Byte offset 0x74, CSR Addr 0x5403a, Direction=in
                              // Value to be programmed in DRAM Mode Register 13 {Channel B, Rank 0}
   uint8_t  MR13_B1;          // Byte offset 0x75, CSR Addr 0x5403a, Direction=in
                              // Value to be programmed in DRAM Mode Register 13 {Channel B, Rank 1}
   uint8_t  MR14_A0;          // Byte offset 0x76, CSR Addr 0x5403b, Direction=in
                              // Value to be programmed in DRAM Mode Register 14 {Channel A, Rank 0}
   uint8_t  MR14_A1;          // Byte offset 0x77, CSR Addr 0x5403b, Direction=in
                              // Value to be programmed in DRAM Mode Register 14 {Channel A, Rank 1}
   uint8_t  MR14_B0;          // Byte offset 0x78, CSR Addr 0x5403c, Direction=in
                              // Value to be programmed in DRAM Mode Register 14 {Channel B, Rank 0}
   uint8_t  MR14_B1;          // Byte offset 0x79, CSR Addr 0x5403c, Direction=in
                              // Value to be programmed in DRAM Mode Register 14 {Channel B, Rank 1}
   uint8_t  MR15_A0;          // Byte offset 0x7a, CSR Addr 0x5403d, Direction=in
                              // Value to be programmed in DRAM Mode Register 15 {Channel A, Rank 0}
   uint8_t  MR15_A1;          // Byte offset 0x7b, CSR Addr 0x5403d, Direction=in
                              // Value to be programmed in DRAM Mode Register 15 {Channel A, Rank 1}
   uint8_t  MR15_B0;          // Byte offset 0x7c, CSR Addr 0x5403e, Direction=in
                              // Value to be programmed in DRAM Mode Register 15 {Channel B, Rank 0}
   uint8_t  MR15_B1;          // Byte offset 0x7d, CSR Addr 0x5403e, Direction=in
                              // Value to be programmed in DRAM Mode Register 15 {Channel B, Rank 1}
   uint8_t  MR16_A0;          // Byte offset 0x7e, CSR Addr 0x5403f, Direction=in
                              // Value to be programmed in DRAM Mode Register 16 {Channel A, Rank 0}
   uint8_t  MR16_A1;          // Byte offset 0x7f, CSR Addr 0x5403f, Direction=in
                              // Value to be programmed in DRAM Mode Register 16 {Channel A, Rank 1}
   uint8_t  MR16_B0;          // Byte offset 0x80, CSR Addr 0x54040, Direction=in
                              // Value to be programmed in DRAM Mode Register 16 {Channel B, Rank 0}
   uint8_t  MR16_B1;          // Byte offset 0x81, CSR Addr 0x54040, Direction=in
                              // Value to be programmed in DRAM Mode Register 16 {Channel B, Rank 1}
   uint8_t  MR17_A0;          // Byte offset 0x82, CSR Addr 0x54041, Direction=in
                              // Value to be programmed in DRAM Mode Register 17 {Channel A, Rank 0}
   uint8_t  MR17_A1;          // Byte offset 0x83, CSR Addr 0x54041, Direction=in
                              // Value to be programmed in DRAM Mode Register 17 {Channel A, Rank 1}
   uint8_t  MR17_B0;          // Byte offset 0x84, CSR Addr 0x54042, Direction=in
                              // Value to be programmed in DRAM Mode Register 17 {Channel B, Rank 0}
   uint8_t  MR17_B1;          // Byte offset 0x85, CSR Addr 0x54042, Direction=in
                              // Value to be programmed in DRAM Mode Register 17 {Channel B, Rank 1}
   uint8_t  MR18_A0;          // Byte offset 0x86, CSR Addr 0x54043, Direction=in
                              // Value to be programmed in DRAM Mode Register 18 {Channel A, Rank 0}
   uint8_t  MR18_A1;          // Byte offset 0x87, CSR Addr 0x54043, Direction=in
                              // Value to be programmed in DRAM Mode Register 18 {Channel A, Rank 1}
   uint8_t  MR18_B0;          // Byte offset 0x88, CSR Addr 0x54044, Direction=in
                              // Value to be programmed in DRAM Mode Register 18 {Channel B, Rank 0}
   uint8_t  MR18_B1;          // Byte offset 0x89, CSR Addr 0x54044, Direction=in
                              // Value to be programmed in DRAM Mode Register 18 {Channel B, Rank 1}
   uint8_t  MR19_A0;          // Byte offset 0x8a, CSR Addr 0x54045, Direction=in
                              // Value to be programmed in DRAM Mode Register 19 {Channel A, Rank 0}
   uint8_t  MR19_A1;          // Byte offset 0x8b, CSR Addr 0x54045, Direction=in
                              // Value to be programmed in DRAM Mode Register 19 {Channel A, Rank 1}
   uint8_t  MR19_B0;          // Byte offset 0x8c, CSR Addr 0x54046, Direction=in
                              // Value to be programmed in DRAM Mode Register 19 {Channel B, Rank 0}
   uint8_t  MR19_B1;          // Byte offset 0x8d, CSR Addr 0x54046, Direction=in
                              // Value to be programmed in DRAM Mode Register 19 {Channel B, Rank 1}
   uint8_t  MR20_A0;          // Byte offset 0x8e, CSR Addr 0x54047, Direction=in
                              // Value to be programmed in DRAM Mode Register 20 {Channel A, Rank 0}
   uint8_t  MR20_A1;          // Byte offset 0x8f, CSR Addr 0x54047, Direction=in
                              // Value to be programmed in DRAM Mode Register 20 {Channel A, Rank 1}
   uint8_t  MR20_B0;          // Byte offset 0x90, CSR Addr 0x54048, Direction=in
                              // Value to be programmed in DRAM Mode Register 20 {Channel B, Rank 0}
   uint8_t  MR20_B1;          // Byte offset 0x91, CSR Addr 0x54048, Direction=in
                              // Value to be programmed in DRAM Mode Register 20 {Channel B, Rank 1}
   uint8_t  MR21_A0;          // Byte offset 0x92, CSR Addr 0x54049, Direction=in
                              // Value to be programmed in DRAM Mode Register 21 {Channel A, Rank 0}
   uint8_t  MR21_A1;          // Byte offset 0x93, CSR Addr 0x54049, Direction=in
                              // Value to be programmed in DRAM Mode Register 21 {Channel A, Rank 1}
   uint8_t  MR21_B0;          // Byte offset 0x94, CSR Addr 0x5404a, Direction=in
                              // Value to be programmed in DRAM Mode Register 21 {Channel B, Rank 0}
   uint8_t  MR21_B1;          // Byte offset 0x95, CSR Addr 0x5404a, Direction=in
                              // Value to be programmed in DRAM Mode Register 21 {Channel B, Rank 1}
   uint8_t  MR22_A0;          // Byte offset 0x96, CSR Addr 0x5404b, Direction=in
                              // Value to be programmed in DRAM Mode Register 22 {Channel A, Rank 0}
   uint8_t  MR22_A1;          // Byte offset 0x97, CSR Addr 0x5404b, Direction=in
                              // Value to be programmed in DRAM Mode Register 22 {Channel A, Rank 1}
   uint8_t  MR22_B0;          // Byte offset 0x98, CSR Addr 0x5404c, Direction=in
                              // Value to be programmed in DRAM Mode Register 22 {Channel B, Rank 0}
   uint8_t  MR22_B1;          // Byte offset 0x99, CSR Addr 0x5404c, Direction=in
                              // Value to be programmed in DRAM Mode Register 22 {Channel B, Rank 1}
   uint8_t  MR24_A0;          // Byte offset 0x9a, CSR Addr 0x5404d, Direction=in
                              // Value to be programmed in DRAM Mode Register 24 {Channel A, Rank 0}
   uint8_t  MR24_A1;          // Byte offset 0x9b, CSR Addr 0x5404d, Direction=in
                              // Value to be programmed in DRAM Mode Register 24 {Channel A, Rank 1}
   uint8_t  MR24_B0;          // Byte offset 0x9c, CSR Addr 0x5404e, Direction=in
                              // Value to be programmed in DRAM Mode Register 24 {Channel B, Rank 0}
   uint8_t  MR24_B1;          // Byte offset 0x9d, CSR Addr 0x5404e, Direction=in
                              // Value to be programmed in DRAM Mode Register 24 {Channel B, Rank 1}
   uint8_t  MR25_A0;          // Byte offset 0x9e, CSR Addr 0x5404f, Direction=in
                              // Value to be programmed in DRAM Mode Register 25 {Channel A, Rank 0}
   uint8_t  MR25_A1;          // Byte offset 0x9f, CSR Addr 0x5404f, Direction=in
                              // Value to be programmed in DRAM Mode Register 25 {Channel A, Rank 1}
   uint8_t  MR25_B0;          // Byte offset 0xa0, CSR Addr 0x54050, Direction=in
                              // Value to be programmed in DRAM Mode Register 25 {Channel B, Rank 0}
   uint8_t  MR25_B1;          // Byte offset 0xa1, CSR Addr 0x54050, Direction=in
                              // Value to be programmed in DRAM Mode Register 25 {Channel B, Rank 1}
   uint8_t  MR26_A0;          // Byte offset 0xa2, CSR Addr 0x54051, Direction=in
                              // Value to be programmed in DRAM Mode Register 26 {Channel A, Rank 0}
   uint8_t  MR26_A1;          // Byte offset 0xa3, CSR Addr 0x54051, Direction=in
                              // Value to be programmed in DRAM Mode Register 26 {Channel A, Rank 1}
   uint8_t  MR26_B0;          // Byte offset 0xa4, CSR Addr 0x54052, Direction=in
                              // Value to be programmed in DRAM Mode Register 26 {Channel B, Rank 0}
   uint8_t  MR26_B1;          // Byte offset 0xa5, CSR Addr 0x54052, Direction=in
                              // Value to be programmed in DRAM Mode Register 26 {Channel B, Rank 1}
   uint8_t  MR27_A0;          // Byte offset 0xa6, CSR Addr 0x54053, Direction=in
                              // Value to be programmed in DRAM Mode Register 27 {Channel A, Rank 0}
   uint8_t  MR27_A1;          // Byte offset 0xa7, CSR Addr 0x54053, Direction=in
                              // Value to be programmed in DRAM Mode Register 27 {Channel A, Rank 1}
   uint8_t  MR27_B0;          // Byte offset 0xa8, CSR Addr 0x54054, Direction=in
                              // Value to be programmed in DRAM Mode Register 27 {Channel B, Rank 0}
   uint8_t  MR27_B1;          // Byte offset 0xa9, CSR Addr 0x54054, Direction=in
                              // Value to be programmed in DRAM Mode Register 27 {Channel B, Rank 1}
   uint8_t  MR28_A0;          // Byte offset 0xaa, CSR Addr 0x54055, Direction=in
                              // Value to be programmed in DRAM Mode Register 28 {Channel A, Rank 0}
   uint8_t  MR28_A1;          // Byte offset 0xab, CSR Addr 0x54055, Direction=in
                              // Value to be programmed in DRAM Mode Register 28 {Channel A, Rank 1}
   uint8_t  MR28_B0;          // Byte offset 0xac, CSR Addr 0x54056, Direction=in
                              // Value to be programmed in DRAM Mode Register 28 {Channel B, Rank 0}
   uint8_t  MR28_B1;          // Byte offset 0xad, CSR Addr 0x54056, Direction=in
                              // Value to be programmed in DRAM Mode Register 28 {Channel B, Rank 1}
   uint8_t  MR30_A0;          // Byte offset 0xae, CSR Addr 0x54057, Direction=in
                              // Value to be programmed in DRAM Mode Register 30 {Channel A, Rank 0}
   uint8_t  MR30_A1;          // Byte offset 0xaf, CSR Addr 0x54057, Direction=in
                              // Value to be programmed in DRAM Mode Register 30 {Channel A, Rank 1}
   uint8_t  MR30_B0;          // Byte offset 0xb0, CSR Addr 0x54058, Direction=in
                              // Value to be programmed in DRAM Mode Register 30 {Channel B, Rank 0}
   uint8_t  MR30_B1;          // Byte offset 0xb1, CSR Addr 0x54058, Direction=in
                              // Value to be programmed in DRAM Mode Register 30 {Channel B, Rank 1}
   uint8_t  MR31_A0;          // Byte offset 0xb2, CSR Addr 0x54059, Direction=in
                              // Value to be programmed in DRAM Mode Register 31 {Channel A, Rank 0}
   uint8_t  MR31_A1;          // Byte offset 0xb3, CSR Addr 0x54059, Direction=in
                              // Value to be programmed in DRAM Mode Register 31 {Channel A, Rank 1}
   uint8_t  MR31_B0;          // Byte offset 0xb4, CSR Addr 0x5405a, Direction=in
                              // Value to be programmed in DRAM Mode Register 31 {Channel B, Rank 0}
   uint8_t  MR31_B1;          // Byte offset 0xb5, CSR Addr 0x5405a, Direction=in
                              // Value to be programmed in DRAM Mode Register 31 {Channel B, Rank 1}
   uint8_t  MR32_A0;          // Byte offset 0xb6, CSR Addr 0x5405b, Direction=in
                              // Value to be programmed in DRAM Mode Register 32 {Channel A, Rank 0}
   uint8_t  MR32_A1;          // Byte offset 0xb7, CSR Addr 0x5405b, Direction=in
                              // Value to be programmed in DRAM Mode Register 32 {Channel A, Rank 1}
   uint8_t  MR32_B0;          // Byte offset 0xb8, CSR Addr 0x5405c, Direction=in
                              // Value to be programmed in DRAM Mode Register 32 {Channel B, Rank 0}
   uint8_t  MR32_B1;          // Byte offset 0xb9, CSR Addr 0x5405c, Direction=in
                              // Value to be programmed in DRAM Mode Register 32 {Channel B, Rank 1}
   uint8_t  MR33_A0;          // Byte offset 0xba, CSR Addr 0x5405d, Direction=in
                              // Value to be programmed in DRAM Mode Register 33 {Channel A, Rank 0}
   uint8_t  MR33_A1;          // Byte offset 0xbb, CSR Addr 0x5405d, Direction=in
                              // Value to be programmed in DRAM Mode Register 33 {Channel A, Rank 1}
   uint8_t  MR33_B0;          // Byte offset 0xbc, CSR Addr 0x5405e, Direction=in
                              // Value to be programmed in DRAM Mode Register 33 {Channel B, Rank 0}
   uint8_t  MR33_B1;          // Byte offset 0xbd, CSR Addr 0x5405e, Direction=in
                              // Value to be programmed in DRAM Mode Register 33 {Channel B, Rank 1}
   uint8_t  MR34_A0;          // Byte offset 0xbe, CSR Addr 0x5405f, Direction=in
                              // Value to be programmed in DRAM Mode Register 34 {Channel A, Rank 0}
   uint8_t  MR34_A1;          // Byte offset 0xbf, CSR Addr 0x5405f, Direction=in
                              // Value to be programmed in DRAM Mode Register 34 {Channel A, Rank 1}
   uint8_t  MR34_B0;          // Byte offset 0xc0, CSR Addr 0x54060, Direction=in
                              // Value to be programmed in DRAM Mode Register 34 {Channel B, Rank 0}
   uint8_t  MR34_B1;          // Byte offset 0xc1, CSR Addr 0x54060, Direction=in
                              // Value to be programmed in DRAM Mode Register 34 {Channel B, Rank 1}
   uint8_t  MR37_A0;          // Byte offset 0xc2, CSR Addr 0x54061, Direction=in
                              // Value to be programmed in DRAM Mode Register 37 {Channel A, Rank 0}
   uint8_t  MR37_A1;          // Byte offset 0xc3, CSR Addr 0x54061, Direction=in
                              // Value to be programmed in DRAM Mode Register 37 {Channel A, Rank 1}
   uint8_t  MR37_B0;          // Byte offset 0xc4, CSR Addr 0x54062, Direction=in
                              // Value to be programmed in DRAM Mode Register 37 {Channel B, Rank 0}
   uint8_t  MR37_B1;          // Byte offset 0xc5, CSR Addr 0x54062, Direction=in
                              // Value to be programmed in DRAM Mode Register 37 {Channel B, Rank 1}
   uint8_t  MR40_A0;          // Byte offset 0xc6, CSR Addr 0x54063, Direction=in
                              // Value to be programmed in DRAM Mode Register 40 {Channel A, Rank 0}
   uint8_t  MR40_A1;          // Byte offset 0xc7, CSR Addr 0x54063, Direction=in
                              // Value to be programmed in DRAM Mode Register 40 {Channel A, Rank 1}
   uint8_t  MR40_B0;          // Byte offset 0xc8, CSR Addr 0x54064, Direction=in
                              // Value to be programmed in DRAM Mode Register 40 {Channel B, Rank 0}
   uint8_t  MR40_B1;          // Byte offset 0xc9, CSR Addr 0x54064, Direction=in
                              // Value to be programmed in DRAM Mode Register 40 {Channel B, Rank 1}
   uint8_t  MR41_A0;          // Byte offset 0xca, CSR Addr 0x54065, Direction=in
                              // Value to be programmed in DRAM Mode Register 41 {Channel A, Rank 0}
   uint8_t  MR41_A1;          // Byte offset 0xcb, CSR Addr 0x54065, Direction=in
                              // Value to be programmed in DRAM Mode Register 41 {Channel A, Rank 1}
   uint8_t  MR41_B0;          // Byte offset 0xcc, CSR Addr 0x54066, Direction=in
                              // Value to be programmed in DRAM Mode Register 41 {Channel B, Rank 0}
   uint8_t  MR41_B1;          // Byte offset 0xcd, CSR Addr 0x54066, Direction=in
                              // Value to be programmed in DRAM Mode Register 41 {Channel B, Rank 1}
   uint8_t  Disable2D;        // Byte offset 0xce, CSR Addr 0x54067, Direction=In
                              // Set to disable 2D training
   uint8_t  VrefSamples;      // Byte offset 0xcf, CSR Addr 0x54067, Direction=In
                              // Number of vrefs to scan 
                              // 0 =  scan default vref
   uint8_t  TrainedVREFDQU_A0; // Byte offset 0xd0, CSR Addr 0x54068, Direction=Out
                              // Trained CA DQ Upper setting for Ch A Rank 0
   uint8_t  TrainedDRAMDFE_A0; // Byte offset 0xd1, CSR Addr 0x54068, Direction=Out
                              // Trained DRAM DFE setting for Ch A Rank 0 
                              //   Upper byte [6:4]
                              //   Lower byte  [2:0]
   uint8_t  TrainedDRAMDCA_A0; // Byte offset 0xd2, CSR Addr 0x54069, Direction=Out
                              // Trained DRAM DCA 
                              //   Upper byte [7:4]
                              //   Lower byte [3:0]
   uint8_t  TrainedPHYRdDCA_A0; // Byte offset 0xd3, CSR Addr 0x54069, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedPHYWrDCA_A0; // Byte offset 0xd4, CSR Addr 0x5406a, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedVREFDQU_A1; // Byte offset 0xd5, CSR Addr 0x5406a, Direction=Out
                              // Trained CA DQ Upper setting for Ch A Rank 1
   uint8_t  TrainedDRAMDFE_A1; // Byte offset 0xd6, CSR Addr 0x5406b, Direction=Out
                              // Trained DRAM DFE setting for Ch A Rank 1
                              //   Upper byte [6:4]
                              //   Lower byte  [2:0]
   uint8_t  TrainedDRAMDCA_A1; // Byte offset 0xd7, CSR Addr 0x5406b, Direction=Out
                              // Trained DRAM DCA 
                              //   Upper byte [7:4]
                              //   Lower byte [3:0]
   uint8_t  TrainedPHYRdDCA_A1; // Byte offset 0xd8, CSR Addr 0x5406c, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedPHYWrDCA_A1; // Byte offset 0xd9, CSR Addr 0x5406c, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedVREFDQU_B0; // Byte offset 0xda, CSR Addr 0x5406d, Direction=Out
                              // Trained CA DQ Upper setting for Ch B Rank 0
   uint8_t  TrainedDRAMDFE_B0; // Byte offset 0xdb, CSR Addr 0x5406d, Direction=Out
                              // Trained DRAM DFE setting for Ch B Rank 0
                              //   Upper byte [6:4]
                              //   Lower byte  [2:0]
   uint8_t  TrainedDRAMDCA_B0; // Byte offset 0xdc, CSR Addr 0x5406e, Direction=Out
                              // Trained DRAM DCA 
                              //   Upper byte [7:4]
                              //   Lower byte [3:0]
   uint8_t  TrainedPHYRdDCA_B0; // Byte offset 0xdd, CSR Addr 0x5406e, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedPHYWrDCA_B0; // Byte offset 0xde, CSR Addr 0x5406f, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedVREFDQU_B1; // Byte offset 0xdf, CSR Addr 0x5406f, Direction=Out
                              // Trained CA DQ Upper setting for Ch B Rank 1
   uint8_t  TrainedDRAMDFE_B1; // Byte offset 0xe0, CSR Addr 0x54070, Direction=Out
                              // Trained DRAM DFE setting for Ch B Rank 1
                              //   Upper byte [6:4]
                              //   Lower byte  [2:0]
   uint8_t  TrainedDRAMDCA_B1; // Byte offset 0xe1, CSR Addr 0x54070, Direction=Out
                              // Trained DRAM DCA 
                              //   Upper byte [7:4]
                              //   Lower byte [3:0]
   uint8_t  TrainedPHYRdDCA_B1; // Byte offset 0xe2, CSR Addr 0x54071, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  TrainedPHYWrDCA_B1; // Byte offset 0xe3, CSR Addr 0x54071, Direction=Out
                              // Distance from the trained center to the closest failing region in DLL steps. This value is the minimum of all eyes in this timing group.
   uint8_t  RdWrPatternA;     // Byte offset 0xe4, CSR Addr 0x54072, Direction=In
                              // Lower-byte read and write pattern for training 
                              // When set to 0 uses default patterns
   uint8_t  RdWrPatternB;     // Byte offset 0xe5, CSR Addr 0x54072, Direction=In
                              // Upper-byte read and write pattern for training 
                              // When set to 0 uses default patterns
   uint8_t  RdWrInvertA;      // Byte offset 0xe6, CSR Addr 0x54073, Direction=In
                              // Lower-byte per bit  invert for read and write pattern for training 
                              // When RdWrPatternA and RdWrPatternB = 0 this is unused
   uint8_t  RdWrInvertB;      // Byte offset 0xe7, CSR Addr 0x54073, Direction=In
   ...
   uint8_t  Reserved3FF;      // Byte offset 0x3ff, CSR Addr 0x541ff, Direction=N/A
                              // This field is reserved and must be programmed to 0x00.
} __attribute__ ((packed)) PMU_SMB_LPDDR5_2D_t;
