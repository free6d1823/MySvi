 ...
 */
#define IMEM_INCV_FILENAME_2D            FW_FILES_LOC"/lpddr4x_2d/lpddr4x_2d_pmu_train_imem.incv"
#define DMEM_INCV_FILENAME_2D            FW_FILES_LOC"/lpddr4x_2d/lpddr4x_2d_pmu_train_dmem.incv"
...
#include "mnPmuSramMsgBlock_lpddr4x_2d.h"
...
typedef struct phyinit_config {
    ...
    PMU_SMB_LPDDR4X_2D_t        mb_LPDDR4X_2D[DWC_DDRPHY_PHYINIT_MAX_NUM_PSTATE];
    /// Shadow of 2D message block. Used by PhyInit to track user changes to the data structure.
    PMU_SMB_LPDDR4X_2D_t        shdw_LPDDR4X_2D[DWC_DDRPHY_PHYINIT_MAX_NUM_PSTATE];
