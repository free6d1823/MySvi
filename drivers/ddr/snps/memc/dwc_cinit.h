...
extern void cinit_cal_rd2wr_dr(SubsysHdlr_t *hdlr, uint32_t p, uint32_t ch);
extern void cinit_cal_wr2rd_dr(SubsysHdlr_t *hdlr, uint32_t p, uint32_t ch);
extern void cinit_cal_diff_rank_rd_gap(SubsysHdlr_t *hdlr, uint32_t p, uint32_t ch);
extern void cinit_cal_diff_rank_wr_gap(SubsysHdlr_t *hdlr, uint32_t p, uint32_t ch);
extern void cinit_cal_mrr2rdwr(SubsysHdlr_t *hdlr, uint32_t p, uint32_t ch);
...
extern void cinit_prgm_DERATECTL1(SubsysHdlr_t *hdlr);
...
extern void cinit_prgm_DRAMSET1TMG28 (SubsysHdlr_t *hdlr, uint32_t p, uint32_t dch);
extern void cinit_prgm_DRAMSET1TMG29 (SubsysHdlr_t *hdlr, uint32_t p, uint32_t dch);
extern void cinit_prgm_DRAMSET1TMG30 (SubsysHdlr_t *hdlr, uint32_t p, uint32_t dch);
...
extern void cinit_prgm_CRCPOISONCTL0 (SubsysHdlr_t *hdlr, uint32_t dch);
extern void cinit_prgm_LNKECCCTL0 (SubsysHdlr_t *hdlr, uint32_t dch);
extern void cinit_prgm_LNKECCCTL1 (SubsysHdlr_t *hdlr, uint32_t dch);
extern void cinit_prgm_LNKECCPOISONCTL0 (SubsysHdlr_t *hdlr, uint32_t dch);
...
extern void cinit_prgm_DFILPTMG1 (SubsysHdlr_t *hdlr,uint32_t dch);
...
extern void cinit_prgm_CRCPARTMG1 (SubsysHdlr_t *hdlr,uint32_t p,uint32_t dch);
