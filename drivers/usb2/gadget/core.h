...
#define DWC3_BLOOPBCKCTRL		0xd900
#define DWC3_BLOOPBCKTFERSZ	 	0xd904
...
#define DWC3_DCTL_SCALEDOWNENA		(0x3 << 4)
...
/* BLOOPBCKCTRL register bit definition */
#define DWC3_LPBACK_LEVEL_SSP_PIPE	(0x0 << 2)
#define DWC3_LPBACK_LEVEL_SSP_PHY	(0x1 << 2)

#define DWC3_LPBACK_MODE_SW			(0x0 << 1)
#define DWC3_LPBACK_MODE_BISTHW		(0x1 << 1)

#define DWC3_LPBACK_MODE_EN			(0x1 << 0)
#define DWC3_LPBACK_MODE_DIS		(0x0 << 0)

/* DCFGL register bit definition */
#define DWC3_DCFGL_DEVSPD_ESS		(0x5 << 0)
#define DWC3_DCFGL_DEVSPD_SS		(0x4 << 0)
#define DWC3_DCFGL_DEVSPD_HS		(0x0 << 0)
#define DWC3_DCFGL_DEVSPD_FS		(0x1 << 0)
