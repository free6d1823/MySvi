...
#include "target/mbedtls/cipher_internal.h"
...
static void *gcm_ctx_alloc( void )
{
    ...
    void *ctx = (void*)(MBEDTLS_BUF+0x100);//heap_alloc(sizeof( mbedtls_gcm_context ) );
    if( ctx != NULL )
...
{
    void *ctx = (void*)(MBEDTLS_BUF+0x200); //heap_alloc( sizeof( mbedtls_ccm_context ) );
...
{
    mbedtls_aes_context *aes = (mbedtls_aes_context*)(MBEDTLS_BUF + 0x300);//heap_alloc(sizeof( mbedtls_aes_context ) );
...
{
    mbedtls_aes_xts_context *xts_ctx = (mbedtls_aes_xts_context*)(MBEDTLS_BUF+0x400);//heap_alloc(sizeof( *xts_ctx ) );
