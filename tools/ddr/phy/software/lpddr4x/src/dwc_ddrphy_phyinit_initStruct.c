...
void dwc_ddrphy_phyinit_initStruct (phyinit_config_t* phyctx  /**< phyctx phyinit context */) {
    ...
    PMU_SMB_LPDDR4X_2D_t* mb2D = phyctx->mb_LPDDR4X_2D;
    ...
    PMU_SMB_LPDDR4X_2D_t* shdw2D = phyctx->shdw_LPDDR4X_2D;
    ...
    pUserInputBasic->Lp4xMode                 = 0x0001;
    ...
    for (myps=0; myps<DWC_DDRPHY_PHYINIT_MAX_NUM_PSTATE; myps++) {
        ...
        memset((void *) &shdw2D[myps], 0, sizeof(PMU_SMB_LPDDR4X_2D_t)); // Zero out struct contents
      } // myps
    } // Train2D
