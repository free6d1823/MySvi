...
void dwc_ddrphy_phyinit_userCustom_overrideUserInput (phyinit_config_t* phyctx) {
 overrideUserInput_sv();
    ...
    // dwc_ddrphy_phyinit_setMb (phyctx, 0, "HdtCtrl", 0x8, 0);
    // dwc_ddrphy_phyinit_setMb (phyctx, 1, "HdtCtrl", 0x8, 0);
    // dwc_ddrphy_phyinit_setMb (phyctx, 2, "HdtCtrl", 0x8, 0);
    // dwc_ddrphy_phyinit_setMb (phyctx, 3, "HdtCtrl", 0x8, 0);
