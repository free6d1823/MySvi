 ...
 *
 * Description:
 *   This module contains the functions to manage / utilize a list of byte
 *   values.
 * Notes:
 *   The list is ordered such that each addition is made at the end. No
 *   ordering is imposed based on the value of the bytes in the list. Each
 *   byte value is independent and a single value can be replicated any
 *   number of times to the capacity of the list.
 ****************************************************************************/
